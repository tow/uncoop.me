...
function exporter_init_dialog() {
    ...
    container.html(exporter_dialog_create());
}
...
function exporter_dialog_create() {
    return '<div id="exporter-window" style="padding:30px;">'+
        ...
        '<button class="exporter-download-ofx">Download OFX</div>'+
        '</div>'+
...
function exporter_init() {
    var overlay = $('<div id="exporter-overlay"></div>');
    $('body').append(overlay);
    overlay.click(exporter_close);
